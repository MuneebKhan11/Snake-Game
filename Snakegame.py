...
screen.title('Snake Game by Muneeb Khan')
screen.setup(width=1200, height=786)
screen.tracer(0)
...
scoring.hideturtle()
scoring.goto(0, 300)
scoring.write("Press any arrow key to start the game", align="center", font=("Courier",24,"bold"))
...
while True:
    ...
    for food in old_fruit:
        if food.distance(snake) < 20:
            ...
            print("\n")
            if(score<15):
                scoring.print("That was not good at all",align="left", font=("Courier", 10, "bold"))
            elif(score>16 or score <30):
                print("Not bad at all !")
            elif(score>31 or score<50):
                print("Good Game! ")
            elif(score>50 or score<70):
